    ...
    "features": [
        <#list features as feature>
        {
            ...
            "properties": {
                ...
                <#if feature.properties?exists><#list feature.properties?keys as key><#if key?exists><#assign value = feature.properties[key]><#if value?has_content><#if value?is_number>"${key}":${value?string.computer}<#if key_has_next>,
